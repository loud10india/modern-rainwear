                ...
                <div className='home-content text-start'>
                    <div className='row'>
                        ...
                        <div className='col-md-6 d-flex align-items-center mb-sm-60'>
                            <div>
                                <h2 className='section-caption mb-30 mb-xs-10 wow fadeInUp' data-wow-duration='1.2s' style={{ fontWeight: "600" }}>
                                    Welcome to Modern Rainwear
                                </h2>
                                <h1 className='hs-title-1 mb-30'>
                                    <AnimatedText text={"Best Rainwear Manufacturer in India."} />
                                </h1>

                                <p className='section-descr mb-50 wow fadeInUp' data-wow-delay='0.6s' data-wow-duration='1.2s'>
                                    Your trusted partner for wholesale rainwear, custom raincoats, and bulk orders. Superior quality at unbeatable
                                    prices.
                                </p>
                                {/* <div
                            ...
                            <div className='stack-images'>
                                <div className='stack-images-1 parallax-mousemove' data-offset={30}>
                                    <div className='wow clipRightIn' data-wow-delay='1.2s' data-wow-duration='1.75s'>
                                        <Image src='/assets/images/926.jpg' alt='Image Description' width={600} height={800} />
                                    </div>
                                </div>
                                <div className='stack-images-2 parallax-mousemove' data-offset={60}>
                                    <div className='wow clipRightIn' data-wow-delay='1.7s' data-wow-duration='1.75s'>
                                        <Image width={600} height={800} src='/assets/images/744.jpg' alt='Image Description' />
                                    </div>
                                </div>
                                <div className='stack-images-3 parallax-mousemove' data-offset={90}>
                                    <div className='wow clipRightIn' data-wow-delay='2.2s' data-wow-duration='1.75s'>
                                        <Image width={600} height={800} src='/assets/images/805.jpg' alt='Image Description' />
                                    </div>
                                </div>
                            </div>
                        </div>
